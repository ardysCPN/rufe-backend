...
public interface IUsuarioDao {
    ...
    // Métodos para obtener permisos (menu_item_ids) asociados a un usuario a través
    // de su rol
    Set<Long> findMenuItemIdsByUserId(Long userId);

    // Función de BD para login:
    // Retorna Usuario con detalles de Rol y Organizacion para facilitar la
    ...
    // Nueva función para login solo con email
    Optional<UsuarioWithDetails> findUserWithDetailsByEmail(String email);
