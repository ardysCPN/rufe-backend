...
-- public.estado_bien definition
CREATE TABLE public.estado_bien (
	id serial4 NOT NULL,
	nombre varchar(50) NOT NULL,
	CONSTRAINT estado_bien_nombre_key UNIQUE (nombre),
	CONSTRAINT estado_bien_pkey PRIMARY KEY (id)
);
...
-- public.forma_tenencia_bien definition
CREATE TABLE public.forma_tenencia_bien (
	id serial4 NOT NULL,
	nombre varchar(50) NOT NULL,
	CONSTRAINT forma_tenencia_bien_nombre_key UNIQUE (nombre),
	CONSTRAINT forma_tenencia_bien_pkey PRIMARY KEY (id)
);
...
CREATE TABLE public.genero (
	...
	CONSTRAINT genero_nombre_key UNIQUE (nombre),
...
-- public.organizaciones definition
CREATE TABLE public.organizaciones (
	...
	CONSTRAINT organizaciones_nombre_organizacion_key UNIQUE (nombre_organizacion),
	CONSTRAINT organizaciones_pkey PRIMARY KEY (id)
);

-- Triggers for organizaciones
create trigger set_timestamp_organizaciones before
update
    on
    public.organizaciones for each row execute function actualizar_fecha_modificacion();

-- public.parentesco definition
CREATE TABLE public.parentesco (
	id serial4 NOT NULL,
	nombre varchar(50) NOT NULL,
	CONSTRAINT parentesco_nombre_key UNIQUE (nombre),
	CONSTRAINT parentesco_pkey PRIMARY KEY (id)
);

-- public.pertenencia_etnica definition
CREATE TABLE public.pertenencia_etnica (
	id serial4 NOT NULL,
	nombre varchar(100) NOT NULL,
	CONSTRAINT pertenencia_etnica_nombre_key UNIQUE (nombre),
	CONSTRAINT pertenencia_etnica_pkey PRIMARY KEY (id)
);

-- public.tipo_alojamiento_actual definition
CREATE TABLE public.tipo_alojamiento_actual (
	id serial4 NOT NULL,
	nombre varchar(255) NOT NULL,
	CONSTRAINT tipo_alojamiento_actual_nombre_key UNIQUE (nombre),
	CONSTRAINT tipo_alojamiento_actual_pkey PRIMARY KEY (id)
);

-- public.tipo_bien definition
CREATE TABLE public.tipo_bien (
	id serial4 NOT NULL,
	nombre varchar(100) NOT NULL,
	CONSTRAINT tipo_bien_nombre_key UNIQUE (nombre),
	CONSTRAINT tipo_bien_pkey PRIMARY KEY (id)
);
...
CREATE TABLE public.tipo_documento (
	id serial4 NOT NULL,
	nombre varchar(50) NOT NULL,
	CONSTRAINT tipo_documento_nombre_key UNIQUE (nombre),
	CONSTRAINT tipo_documento_pkey PRIMARY KEY (id)
);

-- public.tipo_ubicacion_bien definition
CREATE TABLE public.tipo_ubicacion_bien (
	id serial4 NOT NULL,
	nombre varchar(50) NOT NULL,
	CONSTRAINT tipo_ubicacion_bien_nombre_key UNIQUE (nombre),
...
update
    on
    public.eventos for each row execute function actualizar_fecha_modificacion();
...
CREATE TABLE public.municipio (
	...
	CONSTRAINT municipio_departamento_id_fkey FOREIGN KEY (departamento_id) REFERENCES public.departamento(id)
);
...
update
    on
    public.usuarios for each row execute function actualizar_fecha_modificacion();

-- public.menu_roles definition
CREATE TABLE public.menu_roles (
	id bigserial NOT NULL,
	menu_id int8 NOT NULL,
	rol_id int8 NOT NULL,
	CONSTRAINT menu_roles_pkey PRIMARY KEY (id),
	CONSTRAINT menu_roles_menu_id_fkey FOREIGN KEY (menu_id) REFERENCES public.menu(id),
...
CREATE TABLE public.registros_rufe (
	...
	usuario_registrador_id int8 NOT NULL,
	cliente_id text NULL,
	fecha_registro timestamp NOT NULL,
	tipo_ubicacion_bien_id int4 NULL,
	corregimiento varchar(150) NULL,
	vereda_sector_barrio varchar(150) NULL,
	direccion varchar(255) NULL,
	tipo_alojamiento_actual_id int4 NULL,
	lugar_habitual_residencia text NULL,
	evacuado_fuera_residencia bool NULL,
	observaciones text NULL,
	vo_bo_cmgrd varchar(100) NULL,
	fecha_creacion timestamp DEFAULT now() NOT NULL,
	fecha_actualizacion timestamp DEFAULT now() NOT NULL,
	fecha_eliminacion timestamp NULL,
	...
	CONSTRAINT registros_rufe_evento_id_fkey FOREIGN KEY (evento_id) REFERENCES public.eventos(id),
	CONSTRAINT registros_rufe_organizacion_id_fkey FOREIGN KEY (organizacion_id) REFERENCES public.organizaciones(id) ON DELETE CASCADE,
	CONSTRAINT registros_rufe_tipo_alojamiento_actual_id_fkey FOREIGN KEY (tipo_alojamiento_actual_id) REFERENCES public.tipo_alojamiento_actual(id),
...
create trigger set_timestamp_registros_rufe before
update
    on
    public.registros_rufe for each row execute function actualizar_fecha_modificacion();

-- public.activos_agropecuarios definition
CREATE TABLE public.activos_agropecuarios (
	id bigserial NOT NULL,
	registro_rufe_id int8 NOT NULL,
	cliente_id text NULL,
	registro_rufe_cliente_id text NULL,
	sector varchar(20) NOT NULL,
	tipo_cultivo varchar(100) NULL,
	unidad_medida_agricola varchar(50) NULL,
	area_cantidad_agricola numeric(10, 2) NULL,
	especie_animal varchar(100) NULL,
	cantidad_animal int4 NULL,
	fecha_creacion timestamp DEFAULT now() NOT NULL,
	fecha_actualizacion timestamp DEFAULT now() NOT NULL,
	fecha_eliminacion timestamp NULL,
	CONSTRAINT activos_agropecuarios_cliente_id_key UNIQUE (cliente_id),
	CONSTRAINT activos_agropecuarios_pkey PRIMARY KEY (id),
	CONSTRAINT activos_agropecuarios_sector_check CHECK (((sector)::text = ANY ((ARRAY['AGRICOLA'::character varying, 'PECUARIO'::character varying])::text[]))),
	CONSTRAINT activos_agropecuarios_registro_rufe_id_fkey FOREIGN KEY (registro_rufe_id) REFERENCES public.registros_rufe(id) ON DELETE CASCADE
);

-- Trigger for activos_agropecuarios
create trigger set_timestamp_activos_agropecuarios before
update
    on
    public.activos_agropecuarios for each row execute function actualizar_fecha_modificacion();

-- public.bienes_afectados definition
CREATE TABLE public.bienes_afectados (
	id bigserial NOT NULL,
	registro_rufe_id int8 NOT NULL,
	cliente_id text NULL,
	registro_rufe_cliente_id text NULL,
	tipo_bien_id int4 NULL,
	forma_tenencia_bien_id int4 NULL,
	estado_bien_id int4 NULL,
	fecha_creacion timestamp DEFAULT now() NOT NULL,
	fecha_actualizacion timestamp DEFAULT now() NOT NULL,
	fecha_eliminacion timestamp NULL,
	CONSTRAINT bienes_afectados_cliente_id_key UNIQUE (cliente_id),
	CONSTRAINT bienes_afectados_pkey PRIMARY KEY (id),
	CONSTRAINT bienes_afectados_estado_bien_id_fkey FOREIGN KEY (estado_bien_id) REFERENCES public.estado_bien(id),
	CONSTRAINT bienes_afectados_forma_tenencia_bien_id_fkey FOREIGN KEY (forma_tenencia_bien_id) REFERENCES public.forma_tenencia_bien(id),
	CONSTRAINT bienes_afectados_registro_rufe_id_fkey FOREIGN KEY (registro_rufe_id) REFERENCES public.registros_rufe(id) ON DELETE CASCADE,
	CONSTRAINT bienes_afectados_tipo_bien_id_fkey FOREIGN KEY (tipo_bien_id) REFERENCES public.tipo_bien(id)
);

-- Trigger for bienes_afectados
create trigger set_timestamp_bienes_afectados before
update
    on
    public.bienes_afectados for each row execute function actualizar_fecha_modificacion();

-- public.integrantes_hogar definition
CREATE TABLE public.integrantes_hogar (
	id bigserial NOT NULL,
	registro_rufe_id int8 NOT NULL,
	cliente_id text NULL,
	registro_rufe_cliente_id text NULL,
	...
	CONSTRAINT integrantes_hogar_registro_rufe_id_fkey FOREIGN KEY (registro_rufe_id) REFERENCES public.registros_rufe(id) ON DELETE CASCADE,
	CONSTRAINT integrantes_hogar_tipo_documento_id_fkey FOREIGN KEY (tipo_documento_id) REFERENCES public.tipo_documento(id)
);

-- Trigger for integrantes_hogar
create trigger set_timestamp_integrantes_hogar before
update
    on
...
INSERT INTO tipo_alojamiento_actual (nombre) VALUES ('LUGAR HABITUAL DE SU RESIDENCIA'), ('EVACUADO FUERA DE SU RESIDENCIA');
INSERT INTO forma_tenencia_bien (nombre) VALUES ('ARRENDATARIO'), ('OCUPANTE'), ('POSEEDOR'), ('PROPIETARIO'), ('NO INFORMA');
INSERT INTO estado_bien (nombre) VALUES ('HABITABLE'), ('NO HABITABLE'), ('DESTRUIDO'), ('NO INFORMA'), ('AVERIADO');
INSERT INTO tipo_bien (nombre) VALUES ('VIVIENDA'), ('FINCA'), ('LOCAL COMERCIAL'), ('FÁBRICA'), ('BODEGA'), ('LOTE'), ('CENTRO DE BIENESTAR'), ('CENTRO EDUCATIVO/ESCUELA'), ('CENTRO DE BIENESTAR/ADULTO MAYOR'), ('HOSPITAL'), ('ESTADIO'), ('IGLESIA / INSTITUCIÓN RELIGIOSA'), ('ALCALDIA MUNICIPAL'), ('ESTACION DE POLICÍA');
INSERT INTO tipo_documento (nombre) VALUES ('Registro Civil'), ('Tarjeta de Identidad'), ('Cédula de Ciudadanía'), ('Cédula de Extranjería'), ('Pasaporte'), ('Menor sin identificación'), ('Adulto sin Identidad'), ('No informa'), ('Nit'), ('Otro');
...
BEGIN
    ...
    WHERE u.email = p_email AND o.nombre_organizacion = p_organizacion_nombre;
END;
$$;
